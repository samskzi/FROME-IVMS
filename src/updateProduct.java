...
public class updateProduct extends JPanel {
	...
	public updateProduct() {
		...
		btnUpdateProduct.setForeground(new Color(0, 128, 0));
		...
		panel.setBounds(0, 11, 192, 668);
		add(panel);
		
		JPanel panel_1 = new JPanel();
		panel_1.setBackground(new Color(0, 128, 0));
		panel_1.setBounds(691, 0, 161, 144);
		add(panel_1);
		company.addItem("Hi-Lo");
		company.addItem("Big JO");
		company.addItem("Mr Karbs");
		company.addItem("Tan Tan");
		company.addItem("Ms Rosey");
	}
}
