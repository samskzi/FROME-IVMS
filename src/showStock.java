...
public class showStock extends JPanel {
	...
	public showStock() {
		...
		lblStock.setBounds(322, 26, 196, 21);
		...
		comp.addItem("Hi-Lo");
		comp.addItem("Big JO");
		comp.addItem("Mr Karbs");
		comp.addItem("Tan Tan");
		comp.addItem("Ms Rosey");
		...
		btnExportToExcel.setBackground(new Color(0, 128, 0));
